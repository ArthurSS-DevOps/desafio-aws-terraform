...
A ideia não foi apenas “fazer funcionar”, mas construir uma pequena arquitetura cloud totalmente automatizada, onde toda a infraestrutura é criada utilizando Terraform, sem necessidade de configurar recursos manualmente no console da AWS.
